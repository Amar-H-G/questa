...
const findSubmissionById = (id) => CodingSubmission.findById(id);

module.exports = { createProblem, findProblemById, listProblems, countProblems, createSubmission, findSubmissionById };
